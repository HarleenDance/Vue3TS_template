...
// typescript 相关引用
const {merge} = require('webpack-merge'); // {merge} 用大括号，ES6引用，解决merge is not a function问题
...
let isProduction = process.env.VUE_APP_MODE == "production" ? true : false;
...
const config = {
  ...
  // 输出文件目录
  outputDir: isProduction ? "dist_production" : "dist_testing",
